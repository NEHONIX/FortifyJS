/**
 * Example demonstrating the circular reference fix in FortifyJS
 */
...
app.start(undefined, () => {
  ...
  console.log("");
  console.log("✅ The server should handle all circular references automatically!");
  console.log("🔄 Watch for circular reference detection logs in development mode.");
});
