 ...
 */
export interface UseSecureStateReturn<T extends Record<string, any>> {
 ...
 */
export interface UseSecureObjectReturn<T extends Record<string, any>> {
    /** The secure object */
 ...
 */
export interface UseSecureFormReturn<T extends Record<string, any>> {
