/**
 * @fileoverview Server-related type definitions for FortifyJS Express integration
 *
...
import { PerformanceConfig, PerformanceOptimizationConfig, PerformanceMonitoringConfig } from "./performance";
