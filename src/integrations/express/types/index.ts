/**
 * @fileoverview Main export file for FortifyJS Express integration types
 *
 ...
 * ```typescript
 * // Import all types
 * import * as FortifyTypes from './types';
 *
...
export type {
    AlertConfig as CoreAlertConfig
} from './mod/core';
...
export type {
    AlertConfig as PerformanceAlertConfig
} from './mod/performance';
...
export type {
    RouteRateLimitConfig as RoutingRateLimitConfig
} from './mod/routing';
