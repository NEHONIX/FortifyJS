/**
 * FortifyJS - Worker Pool Manager Module
    ...
    private findLeastBusyWorker(workers: Worker[]): Worker {
        ...
        for (const worker of workers) {
            ...
            if (currentLoad < minLoad) {
                ...
                const currentWorkerLastUsed = this.workerLastUsed.get(worker) || 0;
                const leastBusyWorkerLastUsed = this.workerLastUsed.get(leastBusyWorker) || 0;
