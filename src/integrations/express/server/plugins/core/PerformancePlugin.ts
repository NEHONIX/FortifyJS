...
export abstract class PerformancePlugin implements IPerformancePlugin {
    ...
    /**
     * Initialize performance plugin with FortifyJS utilities
     */
    ...
    private getChunkedResponseSize(res: any): number {
        try {
            ...
            if (res._fortifyResponseSize !== undefined) {
                return res._fortifyResponseSize;
            }

            // Initialize size tracking
            res._fortifyResponseSize = 0;
            ...
            res.write = function (chunk: any, encoding?: any, callback?: any) {
                if (chunk) {
                    ...
                    res._fortifyResponseSize += chunkSize;
                }
    ...
    protected setupResponseSizeTracking(_req: any, res: any): void {
        try {
            ...
            res.end = function (chunk?: any, encoding?: any, callback?: any) {
                ...
                const responseTime = Date.now() - res._fortifyStartTime;
                res.setHeader("X-Response-Size", res._fortifyResponseSize);
