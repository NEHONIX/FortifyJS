...
export interface BasePlugin {
    ...
    execute(context: PluginExecutionContext): Promise<PluginExecutionResult> | PluginExecutionResult;
...
export interface SecurityPlugin extends BasePlugin {
    ...
    authorize?(context: PluginExecutionContext, resource: string): Promise<boolean>;
