...
export class JWTAuthPlugin extends SecurityPlugin {
    public readonly id = "fortify.auth.jwt";
    ...
    private issuer = "fortifyjs";
    private audience = "fortifyjs-app";
    ...
    /**
     * Validate JWT token using FortifyJS Hash utilities
     */
    private async validateJWTToken(token: string): Promise<{
        ...
        try {
            ...
            // Verify signature using FortifyJS Hash
