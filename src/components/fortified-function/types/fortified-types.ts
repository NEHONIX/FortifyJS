/**
 * FortifyJS - Fortified Function Core Types
...
export interface EnhancedFortifiedFunction<T extends any[], R> {
    ...
    getTimingStats(): any;
    clearTimings(): void;
    _fortified: any; // Will be properly typed in the core module
}

// Ultra-fast cache types
...
export const POOL_CONFIGS = [
    { name: "tiny", blockSize: 32, totalBlocks: 2048 },
    { name: "small", blockSize: 128, totalBlocks: 1024 },
    { name: "medium", blockSize: 1024, totalBlocks: 512 },
    { name: "large", blockSize: 4096, totalBlocks: 256 },
] as const;
